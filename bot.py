...
ADMIN_ID = 5596196601
BOT_TOKEN = os.environ.get("8049094194:AAH_quTdGh7Yv33oy32KNYhuHYmCNvV8DIE")  # Use env var for security
...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "daily_task":
        await query.message.reply_text("🔗 Send today’s Instagram or YouTube video link to like or watch.")
...
def main():
    app = ApplicationBuilder().token(8049094194:AAH_quTdGh7Yv33oy32KNYhuHYmCNvV8DIE).build()
